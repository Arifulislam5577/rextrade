    ...
    >
      <div className="main-container">
        ...
        <ul className="mt-12 grid gap-5 sm:grid-cols-2 lg:mt-14 lg:grid-cols-4">
          ...
          <li className="flex flex-col justify-between gap-6 rounded-3xl bg-sky-500 p-7 text-white">
            <div>
            ...
            <Link
              ...
              scroll={false}
              className="text-ink inline-flex items-center gap-2 self-start rounded-full bg-white px-5 py-2.5 text-sm font-semibold transition-colors hover:bg-sky-50"
            >
